...
<html lang="en">
  ...
  <div id = "main-content"> 
    ...
    <div class = "container px-3 py-3">
      <!-- divider -->
      <h1 class = "title_heading text-center" id="connections"> Connections </h1>
      <div class = "title_description text-center"> Last Updated: <span id='date-time'></span></div>

      <h3 class = "title_heading text-center" id="group"> Current Groups </h3>
      
      
      <!-- Search -->
      <div class="input-group mb-3 mx-auto">
        <input class="form-control py-2 border-right-0 border" type="search" placeholder="Search by skills" id="keyword-search-input" onClick="searchKeyword()">
      </div>
              ...
              <div class="card h-100">
                <div class="row g-0 mx-3">
                  <div class="mx-auto text-center" style="height:200px;">
                    <img id="user_image" v-bind:src="./images/user.picture" alt="User Image" style="height: 100%; width: 100%; object-fit: contain">
                    </div>
                  ...
                  <div class="card-body" id = "skills" v-for="user in users" :key="user.skill">
                      ...
                      <ul class="profile-info-list">
                            ...
                            <li>
                                ...
                                <div class="value"><div class="value"> {{ user.skill }} </div>
                            </li>
