...
<div id="side-nav-short" class="closed">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link active side-icon" aria-current="page" href="../connection/connections.php">
                    <span class="material-icons md-24 d-inline-flex justify-content-center align-items-center menu-option"
...
<div id="side-nav" class="opened">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link side-icon active d-inline-block mx-3 my-2 d-inline-flex align-items-center" aria-current="page" href="../connection/connections.php">
                    <span class="material-icons md-24 d-inline-flex justify-content-center align-items-center pe-2">
                        person_search
                    </span>
                    <span class="d-inline-flex justify-content-center align-items-center body-font icon-label">
...
<div id="side-nav-mobile">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link active side-icon d-inline-block mx-3 my-2 d-inline-flex align-items-center" aria-current="page" href="../connection/connections.php">
                    <span class="material-icons md-24 d-inline-flex justify-content-center align-items-center pe-2">
                        person_search
                    </span>
                    <span class="d-inline-flex justify-content-center align-items-center body-font icon-label">
    ...
    <div id = "main-content">
        <div class="container">
            <h1 class = 'text-center my-3'>Connections</h1>
                ...
                <div v-else class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-3 p-0" v-for="connection in connections">
                            <a :href="'../user/users_page.php?id=' + connection.id" class="card-user-link">
                                <div class="card m-2 connection-card">
                                    <div class="card-body">
                                        <img :src="'../images/' + connection.image_name" alt="" class="img-thumbnail rounded-3 connection-card-image" />
