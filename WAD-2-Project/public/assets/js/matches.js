...
return result;
        ...
        toggleView(elem) {
            if (elem == 'match') {
                ...
                let connectionURL = "../api/retrieveMatches.php";
                ...
                this.viewMatch = true;
            } else if (elem == 'request') {
                console.log(elem);
                let connectionURL = "../api/retrieveRequests.php";
                // let connectionURL = "../api/retrieveMatches.php";
        ...
        sendReq(e) {
            ...
            let match_id = Number.parseInt(e.target.getAttribute("comp-id"));
        ...
        acceptConn(e) {
            let url = "../api/completeRequest.php";
            let match_id = Number.parseInt(e.target.getAttribute("comp-id"));
axios.post(url, {
                match_id: match_id
            })
