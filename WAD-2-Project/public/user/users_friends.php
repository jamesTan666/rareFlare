        ...
        <div id="content" class="content p-0">
            <div class="profile-header" style = 'border-radius:25px'>
                ...
                <ul class="profile-header-tab nav nav-tabs mt-3">
                    <li class="nav-item"><a href="users_page.php?id=<?=$user_id?>" class="nav-link profile-link" data-toggle="tab">ABOUT</a></li>
                    <li class="nav-item"><a href="users_friends.php?id=<?=$user_id?>" class="nav-link active show profile-link" style = "color:#7395AE" data-toggle="tab">CONNECTIONS</a></li>

                </ul>
            </div>

            <div class="profile-container bg-white mt-3" style="border-radius: 25px;">
                <div class="row">
                    <div class="col-md-12">
                        <div class="tab-content p-0">
                            <div class="tab-pane active show" id="profile-about">
                                <div class="tab-pane fade active show" id="profile-friends">
                                    <div class="m-b-10 ms-2 mb-2"><b>Friend List</b></div>
                                    ...
                                    <div v-if="connections.length != 0">
                                        ...
                                        <ul class="friend-list clearfix">
                                            <li v-for="connection in connections">
                                                <a :href="'users.php?id=' + connection.id" class="p-3 m-2 border rounded-3 d-block">
                                                    <div class="friend-img"><img v-if="connection.image_name != ''" :src="'../images/' + connection.image_name" alt="" /></div>
                                                    <div class="friend-info">
                                                        <h4>{{ connection.name }} <small class="text-gold">@{{ connection.username }}</small></h4>
                                                        <span class="d-inline-block rounded-3 me-1 p-1 school-pill">{{ connection.school }} ({{ connection.course }})&nbsp;</span>
                                                        <span v-for="skill in connection.skills" class="d-inline-block rounded-3 me-1 p-1 skill-pill">{{ skill }}</span>
                                                    </div>
                                                </a>
                                            </li>
                                        </ul>
