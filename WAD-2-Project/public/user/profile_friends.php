        ...
        <div id="content" class="content p-0">
            <div class="profile-header" style = 'border-radius:25px'>
                ...
                <ul class="profile-header-tab nav nav-tabs mt-3">
                    ...
                    <li class="nav-item"><a href="profile_friends.php" class="nav-link active show profile-link" style = "color:#7395AE" data-toggle="tab">CONNECTIONS</a></li>
                                            ...
                                            <li v-for="connection in connections">
                                                <a :href="'users.php?id=' + connection.id" class="p-3 m-2 border rounded-3 d-block">
                                                    <div class="friend-img">
                                                        <img v-if="connection.image_name != null" :src="'../images/' + connection.image_name" alt="" />
                                                        <img v-else src="../images/default_profile.jpg" alt="" />
                                                    </div>
